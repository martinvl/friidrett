...
require.define("/workshop/friidrett/register/frontend/src/App.js",function(require,module,exports,__dirname,__filename,process){var io = require('socket.io-client');
...
require.define("/node_modules/socket.io-client/dist/socket.io.js",function(require,module,exports,__dirname,__filename,process){/*! Socket.IO.js build:0.9.11, development. Copyright(c) 2011 LearnBoost <dev@learnboost.com> MIT Licensed */
...
require.define("/workshop/friidrett/view-tests/views/DisciplineSelectionView/DisciplineSelectionView.js",function(require,module,exports,__dirname,__filename,process){var EventEmitter = require('events').EventEmitter;
...
require.define("/workshop/friidrett/view-tests/views/DisciplineSelectionView/DisciplineView.js",function(require,module,exports,__dirname,__filename,process){var EventEmitter = require('events').EventEmitter;
...
require.define("/workshop/friidrett/view-tests/views/ScheduleView/ScheduleView.js",function(require,module,exports,__dirname,__filename,process){var EventEmitter = require('events').EventEmitter;
...
require.define("/workshop/friidrett/view-tests/views/ScheduleView/EventView.js",function(require,module,exports,__dirname,__filename,process){var EventEmitter = require('events').EventEmitter;
...
require.define("/workshop/friidrett/view-tests/views/ContestantsView/ContestantsView.js",function(require,module,exports,__dirname,__filename,process){var EventEmitter = require('events').EventEmitter;
...
require.define("/workshop/friidrett/view-tests/views/ContestantView/ContestantView.js",function(require,module,exports,__dirname,__filename,process){var EventEmitter = require('events').EventEmitter;
...
require.define("/workshop/friidrett/view-tests/views/EventHeaderView/EventHeaderView.js",function(require,module,exports,__dirname,__filename,process){function EventHeaderView() {
    this.initialize();
    this.update();
}
...
require.define("/workshop/friidrett/register/frontend/src/main.js",function(require,module,exports,__dirname,__filename,process){var App = require('./App');

var app = new App();
app.presentDisciplineSelection();

document.body.appendChild(app.el);

});
require("/workshop/friidrett/register/frontend/src/main.js");
})();
